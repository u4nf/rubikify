...
no_file_holder = p.Image.open('no.png').resize((200,200))
...
palette_standard = tk.Radiobutton(window, text='Standard palette', value=1, command=random0)
palette_random = tk.Radiobutton(window, text='Random palette', value=2, command=random1)
