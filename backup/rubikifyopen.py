...
open1 = p.Image.open("open.jpg")														#create and place the zoom button
open_holder1 = ptk.PhotoImage(open1) 
open_file_button = tk.Button(window, image=open_holder1, command=getfile, borderwidth=5)
open_file_button.image = open_holder1	
open_file_button.place(x=650, y=0)
